      ...
      >
        {uploadStatus === 'idle' && (
          <>
            ...
            <div className="buttonDefault uploadActionButton" onClick={(e) => { e.stopPropagation(); openFilePicker(); }}>파일 선택</div>
          </>
        )}
        ...
        {uploadStatus === 'error' && (
          <div className="uploadErrorCard" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="buttonDefault uploadActionButton" onClick={() => setUploadStatus('idle')}>확인</div>
          </div>
        )}
      </div>
